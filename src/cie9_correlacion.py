...
CIE9 = {
    ...
    # --- Completar correlación para todos los diagnósticos curados ---
    # (agregado tras auditar los 414 códigos etiquetados por especialidad:
    # faltaba CIE-9 en 91 de ellos). U071 (COVID-19) se deja sin
    # correlación a propósito: la enfermedad no existía cuando se
    # retiró ICD-9-CM, así que no tiene un código CIE-9 real posible.
    "B07X": ("078.10", "Verrugas víricas, no especificadas"),
    "B350": ("110.0", "Tiña de la barba y del cuero cabelludo"),
    "B354": ("110.5", "Tiña del cuerpo"),
    "D561": ("282.44", "Beta talasemia"),
    "E232": ("253.5", "Diabetes insípida"),
    "E271": ("255.41", "Enfermedad de Addison"),
    "E662": ("278.03", "Síndrome de hipoventilación por obesidad"),
    "E790": ("790.6", "Hiperuricemia"),
    "G042": ("320.9", "Meningitis bacteriana no especificada"),
    "G440": ("346.20", "Cefalea en racimos"),
    "G562": ("354.2", "Lesión del nervio cubital"),
    "G931": ("348.1", "Lesión cerebral anóxica"),
    "G932": ("348.2", "Hipertensión intracraneal benigna"),
    "G934": ("348.30", "Encefalopatía no especificada"),
    "G935": ("348.4", "Compresión del encéfalo"),
    "G936": ("348.5", "Edema cerebral"),
    "H000": ("373.10", "Orzuelo, no especificado"),
    "H040": ("375.00", "Dacrioadenitis"),
    "H110": ("372.40", "Pterigión"),
    "H330": ("361.00", "Desprendimiento de retina con ruptura"),
    "H353": ("362.50", "Degeneración macular"),
    "H501": ("378.10", "Estrabismo divergente concomitante"),
    "H530": ("368.00", "Ambliopía ex anopsia"),
    "H579": ("379.90", "Trastorno del ojo no especificado"),
    "H904": ("389.15", "Hipoacusia neurosensorial asimétrica"),
    "I495": ("427.81", "Síndrome del seno enfermo"),
    "I832": ("454.2", "Venas varicosas con úlcera e inflamación"),
    "I861": ("456.4", "Várices escrotales"),
    "I870": ("459.10", "Síndrome postrombótico"),
    "I872": ("459.81", "Insuficiencia venosa periférica"),
    "J010": ("461.0", "Sinusitis maxilar aguda"),
    "J030": ("034.0", "Amigdalitis estreptocócica"),
    "J340": ("478.19", "Absceso y furúnculo de la nariz"),
    "J342": ("470", "Desviación del tabique nasal"),
    "J91X": ("511.9", "Derrame pleural, no especificado"),
    "K440": ("552.3", "Hernia diafragmática con obstrucción, sin gangrena"),
    "K522": ("558.3", "Gastroenteritis y colitis alérgicas"),
    "K579": ("562.10", "Diverticulosis del colon"),
    "K603": ("565.1", "Fístula anal"),
    "K631": ("569.83", "Perforación del intestino"),
    "K805": ("574.50", "Cálculo del conducto biliar sin colecistitis"),
    "K911": ("564.2", "Síndromes postgastrectomía"),
    "K912": ("579.3", "Malabsorción postquirúrgica"),
    "K913": ("997.4", "Obstrucción intestinal postoperatoria"),
    "K915": ("576.0", "Síndrome de postcolecistectomía"),
    "L050": ("685.0", "Quiste pilonidal con absceso"),
    "L405": ("696.0", "Artropatía psoriásica"),
    "L659": ("704.00", "Alopecia no cicatricial"),
    "L722": ("706.2", "Esteatocistoma múltiple"),
    "M201": ("735.0", "Hallux valgus adquirido"),
    "N434": ("608.1", "Espermatocele"),
    "N872": ("233.1", "Displasia cervical severa (CIE-9 la agrupa con carcinoma in situ)"),
    "O142": ("642.5", "Preeclampsia severa / síndrome HELLP"),
    "O243": ("648.0", "Diabetes mellitus preexistente en el embarazo"),
    "O269": ("646.9", "Complicación del embarazo no especificada"),
    "O369": ("656.9", "Atención materna por problema fetal no especificado"),
    "O470": ("644.03", "Falso trabajo de parto antes de las 37 semanas"),
    "O689": ("656.30", "Trabajo de parto complicado por sufrimiento fetal"),
    "O822": ("669.41", "Cesárea con histerectomía"),
    "O900": ("674.10", "Dehiscencia de sutura de cesárea"),
    "O901": ("674.20", "Dehiscencia de sutura obstétrica perineal"),
    "O903": ("674.50", "Cardiomiopatía del puerperio"),
    "P929": ("779.31", "Problema de alimentación del recién nacido"),
    "R049": ("786.30", "Hemoptisis"),
    "R102": ("625.9", "Dolor pélvico y perineal"),
    "R629": ("783.40", "Falta del desarrollo fisiológico esperado"),
    "R659": ("995.90", "Síndrome de respuesta inflamatoria sistémica"),
    "S050": ("918.1", "Traumatismo de conjuntiva y abrasión corneal"),
    "S222": ("807.2", "Fractura cerrada del esternón"),
    "T140": ("919.9", "Traumatismo superficial de sitio no especificado"),
    "T181": ("935.1", "Cuerpo extraño en el esófago"),
    "T189": ("938", "Cuerpo extraño en el tubo digestivo, no especificado"),
    "T202": ("941.20", "Quemadura de cabeza y cuello, segundo grado"),
    "T391": ("965.4", "Envenenamiento por derivados del paraaminofenol"),
    "T673": ("992.3", "Agotamiento por calor, anhidrótico"),
    "T813": ("998.32", "Desgarro de herida operatoria externa"),
    "T845": ("996.66", "Infección por prótesis articular interna"),
    "Z301": ("V25.1", "Inserción de dispositivo anticonceptivo intrauterino"),
    "Z349": ("V22.9", "Supervisión de embarazo normal"),
    "Z359": ("V23.9", "Supervisión de embarazo de alto riesgo"),
    "Z370": ("V27.0", "Nacido vivo, único"),
    "Z940": ("V42.0", "Trasplante de riñón"),
    "Z946": ("V42.4", "Trasplante de hueso"),
    "Z950": ("V45.01", "Presencia de marcapasos cardíaco"),
    "Z951": ("V45.81", "Estado postderivación aortocoronaria"),
    "Z952": ("V43.3", "Presencia de válvula cardíaca protésica"),
    "Z955": ("V45.82", "Estado postangioplastia coronaria"),
